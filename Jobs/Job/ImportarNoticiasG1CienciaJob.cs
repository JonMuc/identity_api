...
namespace Jobs.Job
{
    public class ImportarNoticiasG1CienciaJob : BaseJob
    {
        protected readonly INoticiaRepository _noticiaRepository;
        protected readonly INoticiaService _noticiaService;

        private static readonly string _urlBaseG1 = "https://g1.globo.com/ciencia/";

        public ImportarNoticiasG1CienciaJob(INoticiaRepository noticiaRepository, INoticiaService noticiaService)
        {
