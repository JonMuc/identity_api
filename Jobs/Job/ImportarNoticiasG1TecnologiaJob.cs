...
namespace Jobs.Job
{
    public class ImportarNoticiasG1TecnologiaJob : BaseJob
    {
        protected readonly INoticiaRepository _noticiaRepository;
        protected readonly INoticiaService _noticiaService;

        private static readonly string _urlBaseG1 = "https://g1.globo.com/tecnologia/";

        public ImportarNoticiasG1TecnologiaJob(INoticiaRepository noticiaRepository, INoticiaService noticiaService)
        {
