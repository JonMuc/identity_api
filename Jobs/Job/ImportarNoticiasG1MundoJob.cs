...
namespace Jobs.Job
{
    public class ImportarNoticiasG1MundoJob : BaseJob
    {
        protected readonly INoticiaRepository _noticiaRepository;
        protected readonly INoticiaService _noticiaService;

        private static readonly string _urlBaseG1 = "https://g1.globo.com/mundo/";

        public ImportarNoticiasG1MundoJob(INoticiaRepository noticiaRepository, INoticiaService noticiaService)
        {
