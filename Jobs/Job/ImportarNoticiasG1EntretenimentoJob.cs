...
namespace Jobs.Job
{
    public class ImportarNoticiasG1EntretenimentoJob : BaseJob
    {
        protected readonly INoticiaRepository _noticiaRepository;
        protected readonly INoticiaService _noticiaService;

        private static readonly string _urlBaseG1 = "https://g1.globo.com/pop-arte/";

        public ImportarNoticiasG1EntretenimentoJob(INoticiaRepository noticiaRepository, INoticiaService noticiaService)
        {
