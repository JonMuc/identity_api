...
namespace Domain.Services
{
    public class UsuarioService : IUsuarioService
    {
        ...
        public UsuarioService(PessoaFisicaValidation pessoaFisicaValidation, IPessoaFisicaRepository pessoaFisicaRepository, IUsuarioRepository usuarioRepository)
        {
